...
if __name__ == "__main__":
    ...
    parse.add_argument('--fname', default = 'data', type=str)

    stop_rule = ['SPRT', 'T-test', 'PSI_Rule', 'esSR', 'sf_SPRT']
    Eli_algo = ['Elimination', 'UCB', 'TS', 'US', 'EG']
    T_test_algo = ['AB']
    PSI_algo = ['PSI']
    esSR_algo = ['esSR']
    sf_SPRT_algo = ['Elimination']
    Algorithm = [Eli_algo, T_test_algo, PSI_algo, esSR_algo, sf_SPRT_algo]
